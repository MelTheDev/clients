...
import { MoveBiometricUnlockToStateProviders } from "./migrations/24-move-biometric-unlock-to-state-providers";
...
export function createMigrationBuilder() {
  return MigrationBuilder.create()
    ...
    .with(MoveBiometricUnlockToStateProviders, 23, CURRENT_VERSION);
}
